	...
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < floorCount; i++)
		{
			...
			do
			{
				...
				tileTotalCost = tileFloorArea(width, length, tilePrice, tileOpt, tileAmount) + tileGroutCalc(width, length, groutPrice, groutSize, groutOpt) + tileFittingCalc(tilePrice, tileOpt, tileAmount); 
			...
			//Ryan Fox
			//Works out the overall cost for the extras, fitting and total cost
			groutOverall[counter] = tileGroutCalc(width, length, groutPrice, groutSize, groutOpt);
			tileFittingOverall[counter] = tileFittingCalc(tilePrice, tileOpt, tileAmount);
			tileOverallCost[counter] = tileFloorArea(width, length, tilePrice, tileOpt, tileAmount);
...
public static double tileFloorArea(double width, double length, double tilePrice, double tileOpt, double tileAmount)
{
...
//Ryan Fox
	...
	tileAmount = area / tileArea;
	
	tilePrice = (area / tileArea) * tilePrice;
...
public static double tileGroutCalc(double width, double length, double groutPrice, double groutSize, double groutOpt)
{	
...
public static double tileFittingCalc(double tilePrice, double tileOpt, double tileAmount)
{	
	
//Ryan Fox
	
	//variables
	double fittingPrice = 50.00;							
	double fittingFee = 0;
	...
	fittingFee = fittingPrice + (tileAmount * fittingFee);
